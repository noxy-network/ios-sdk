...
/* Prefix symbols to avoid conflict with KeccakC from keccak-swift */
#ifndef PQCLEAN_FIPS202_PREFIX
#define PQCLEAN_FIPS202_PREFIX
#endif
#define PQCLEAN_JOIN2(a,b) a##b
#define PQCLEAN_JOIN(a,b) PQCLEAN_JOIN2(a,b)
#define shake128 PQCLEAN_JOIN(PQCLEAN_FIPS202_PREFIX, shake128)
#define shake256 PQCLEAN_JOIN(PQCLEAN_FIPS202_PREFIX, shake256)
#define sha3_256 PQCLEAN_JOIN(PQCLEAN_FIPS202_PREFIX, sha3_256)
#define sha3_384 PQCLEAN_JOIN(PQCLEAN_FIPS202_PREFIX, sha3_384)
#define sha3_512 PQCLEAN_JOIN(PQCLEAN_FIPS202_PREFIX, sha3_512)
